# judedesigns.github.io

Jude Oba's portfolio. Static site — no build step.

- `index.html` · `styles.css` · `main.js` — the whole site
- `assets/vendor/` — GSAP 3.12.5 (+ ScrollTrigger) and Lenis 1.1.18, vendored so the site has no runtime CDN dependency
